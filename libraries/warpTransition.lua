...
do
    ...
    irisOutShader:compileFromFile(nil,Misc.resolveFile("libraries/warpTransition_irisOut.frag"))
    ...
    meltShader:compileFromFile(nil,Misc.resolveFile("libraries/warpTransition_melt.frag"))
