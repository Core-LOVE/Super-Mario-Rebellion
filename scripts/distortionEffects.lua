...
distortionEffects.shader:compileFromFile(nil, Misc.resolveFile("scripts/shaders/distortionEffects.frag"))


distortionEffects.textures = {
    -- both of these are from celeste
    circleHollow = Graphics.loadImageResolved("graphics/distortionEffects_circleHollow.png"),
    circle       = Graphics.loadImageResolved("graphics/distortionEffects_circle.png"),
}
