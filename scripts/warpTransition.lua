...
do
    ...
    irisOutShader:compileFromFile(nil,Misc.resolveFile("scripts/shaders/warpTransition_irisOut.frag"))
    ...
    meltShader:compileFromFile(nil,Misc.resolveFile("scripts/shaders/warpTransition_melt.frag"))
    function warpTransition.TRANSITION_MELT() -- It's the thing from doom :v
        ...
        Graphics.drawScreen{texture = buffer,priority = 0,shader = meltShader,uniforms = {screenWidth = screenWidth, yOffsets = yOffsets}}
    end
