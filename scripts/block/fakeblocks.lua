...
local function initSettings()
    fakeblocks.revealRadius = fakeblocks.revealRadius or 256
    ...
    if type(fakeblocks.silhouetteColor) ~= "Color" then
        fakeblocks.silhouetteColor = Color.fromHexRGB(fakeblocks.silhouetteColor or 0x9E9170)
    end
    init = true
end
...
local nullTex = Graphics.loadImage(Misc.resolveFile("graphics/null.png"))
...
local silhouetteTarget = CaptureBuffer()
local masktarget = CaptureBuffer()
local screeneffectbuffer = CaptureBuffer()
